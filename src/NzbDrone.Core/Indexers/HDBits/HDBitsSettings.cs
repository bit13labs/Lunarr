...
namespace NzbDrone.Core.Indexers.HDBits
{
    ...
    public class HDBitsSettings : ITorrentIndexerSettings
    {
        ...
        [FieldDefinition(8, Type = FieldType.TagSelect, SelectOptions = typeof(IndexerFlags), Label = "Required Flags", HelpText = "What indexer flags are required?", HelpLink = "https://wiki.servarr.com/lunarr/settings#indexer-flags", Advanced = true)]
