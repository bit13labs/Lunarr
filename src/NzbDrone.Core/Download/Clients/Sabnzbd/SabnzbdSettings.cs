...
namespace NzbDrone.Core.Download.Clients.Sabnzbd
{
    ...
    public class SabnzbdSettings : IProviderConfig
    {
        ...
        [FieldDefinition(7, Label = "Category", Type = FieldType.Textbox, HelpText = "Adding a category specific to Lunarr avoids conflicts with unrelated non-Lunarr downloads. Using a category is optional, but strongly recommended.")]
