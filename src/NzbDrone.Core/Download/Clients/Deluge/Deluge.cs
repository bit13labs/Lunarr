            ...
            catch (WebException ex)
            {
                ...
                switch (ex.Status)
                {
                    ...
                    case WebExceptionStatus.ConnectionClosed:
                        ...
                        {
                            DetailedDescription = "Please verify your SSL configuration on both Deluge and Lunarr."
                        };
                    case WebExceptionStatus.SecureChannelFailure:
                        return new NzbDroneValidationFailure("UseSsl", "Unable to connect through SSL")
                        {
                            DetailedDescription = "Drone is unable to connect to Deluge using SSL. This problem could be computer related. Please try to configure both Lunarr and Deluge to not use SSL."
                        };
                    default:
        ...
        private ValidationFailure TestCategory()
        {
            ...
            if (Settings.MovieCategory.IsNotNullOrWhiteSpace() && !labels.Contains(Settings.MovieCategory))
            {
                ...
                if (!labels.Contains(Settings.MovieCategory))
                {
                    ...
                    {
                        DetailedDescription = "Lunarr was unable to add the label to Deluge."
                    };
                }
            }
