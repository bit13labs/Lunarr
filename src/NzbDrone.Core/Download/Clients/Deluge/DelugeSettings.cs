...
namespace NzbDrone.Core.Download.Clients.Deluge
{
    ...
    public class DelugeSettings : IProviderConfig
    {
        ...
        [FieldDefinition(5, Label = "Category", Type = FieldType.Textbox, HelpText = "Adding a category specific to Lunarr avoids conflicts with unrelated non-Lunarr downloads. Using a category is optional, but strongly recommended.")]
        public string MovieCategory { get; set; }

        [FieldDefinition(6, Label = "Post-Import Category", Type = FieldType.Textbox, Advanced = true, HelpText = "Category for Lunarr to set after it has imported the download. Lunarr will not remove the torrent if seeding has finished. Leave blank to keep same category.")]
