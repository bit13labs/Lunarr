...
namespace NzbDrone.Core.Update
{
    ...
    public class UpdatePackageProvider : IUpdatePackageProvider
    {
        ...
        public UpdatePackageProvider(IHttpClient httpClient, ILunarrCloudRequestBuilder requestBuilder, IAnalyticsService analyticsService, IPlatformInfo platformInfo, IMainDatabase mainDatabase)
        {
