...
namespace NzbDrone.Core.Extras.Metadata.Consumers.Xbmc
{
    ...
    public class XbmcMetadataSettings : IProviderConfig
    {
        ...
        [FieldDefinition(1, Label = "Movie Metadata URL", Type = FieldType.Checkbox, HelpText = "Lunarr will write the tmdb/imdb url in the .nfo file", Advanced = true)]
        public bool MovieMetadataURL { get; set; }

        [FieldDefinition(2, Label = "Metadata Language", Type = FieldType.Select, SelectOptions = typeof(RealLanguageFieldConverter), HelpText = "Lunarr will write metadata in the selected language if available")]
        ...
        [FieldDefinition(4, Label = "Use Movie.nfo", Type = FieldType.Checkbox, HelpText = "Lunarr will write metadata to movie.nfo instead of the default <movie-filename>.nfo")]
