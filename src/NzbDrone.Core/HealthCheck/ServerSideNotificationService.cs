...
namespace NzbDrone.Core.HealthCheck
{
    ...
    public class ServerSideNotificationService : IServerSideNotificationService
    {
        ...
        public ServerSideNotificationService(IHttpClient client, IConfigFileProvider configFileProvider, ILunarrCloudRequestBuilder cloudRequestBuilder, Logger logger)
        {
            _client = client;
